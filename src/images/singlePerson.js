...
function SinglePerson(props) {
  return (
    <svg
      ...
      width="428.974px"
      height="428.975px"
      viewBox="0 0 428.974 428.975"
      style="enable-background:new 0 0 428.974 428.975;"
    >
      <g>
        <path
          d="M414.101,373.866l-106.246-56.188l-4.907-15.332c-1.469-5.137-3.794-10.273-8.576-11.623
